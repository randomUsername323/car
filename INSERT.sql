...
insert into ServiceAppointment
  ...
  ('2015-04-13', 'C000', 'V0000', 'E002', '04:30 PM', '39000', '2.25'),
  ('2016-04-30', 'C000', 'V0000', 'E009', '05:30 PM', '51000', '2.25'),

  ('2015-04-11', 'C001', 'V0001', 'E002', '04:30 PM', '44000', '2.25'),
  ('2016-04-13', 'C001', 'V0001', 'E008', '04:30 PM', '66000', '2.25'),
  ('2017-04-13', 'C001', 'V0001', 'E002', '04:30 PM', '78000', '2.25'),

  ('2016-04-12', 'C002', 'V0002', 'E010', '04:30 PM', '126000', '2.25'),

  ('2017-04-14', 'C003', 'V0003', 'E011', '04:30 PM', '40000', '2.25'),

  ('2016-12-13', 'C004', 'V0004', 'E002', '04:30 PM', '40000', '2.25'),
  ('2017-04-23', 'C004', 'V0004', 'E002', '04:30 PM', '55000', '2.25'),

  ('2015-04-13', 'C005', 'V0005', 'E008', '04:30 PM', '20000', '2.25'),

  ('2016-03-13', 'C006', 'V0006', 'E002', '04:30 PM', '4000', '2.25'),
  ('2017-05-13', 'C006', 'V0006', 'E002', '04:30 PM', '9500', '2.25'),

  ('2015-06-13', 'C007', 'V0007', 'E008', '04:30 PM', '25000', '2.25'),

  ('2017-04-13', 'C008', 'V0008', 'E009', '04:30 PM', '65000', '2.25'),

  ('2015-08-13', 'C009', 'V0009', 'E002', '04:30 PM', '110000', '2.25'),

  ('2015-07-13', 'C010', 'V0010', 'E008', '04:30 PM', '25000', '2.25'),
  ('2016-08-13', 'C010', 'V0010', 'E002', '04:30 PM', '35000', '2.25'),

  ('2017-01-13', 'C011', 'V0011', 'E008', '04:30 PM', '70000', '2.25'),

  ('2017-02-13', 'C012', 'V0012', 'E002', '04:30 PM', '80000', '2.25'),

  ('2016-09-13', 'C013', 'V0013', 'E011', '04:30 PM', '39000', '2.25'),
  ('2017-06-13', 'C013', 'V0013', 'E010', '04:30 PM', '60000', '2.25'),

  ('2015-04-21', 'C014', 'V0014', 'E002', '04:30 PM', '9000', '2.25');
...
insert into MaintenanceVisitOrder
  ...
  ('E004', 'MTN000', 'C000', '2016-04-30', 'V0000', 20.50, '65000'), -- PKG000
  ...
  ('E000', 'MTNSIL001', 'C001', '2017-04-13', 'V0001', 30.00, '80000'), 
  ...
  ('E002', 'MTN017', 'C009', '2015-08-13', 'V0009', 30.00, '130000'), -- PKG008
  ('E005', 'MTN018', 'C009', '2015-08-13', 'V0009', 30.00, '130000'), 
  ...
  ('E001', 'MTN011', 'C012', '2017-02-13', 'V0012', 130.00, '95000'), -- PKG005
  ('E000', 'MTN012', 'C012', '2017-02-13', 'V0012', 130.00, '95000'), 

  ('E000', 'MTNGLD000', 'C013', '2016-09-13', 'V0013', 60.00, '60000'), -- GOLD
  ('E001', 'MTNGLD001', 'C013', '2016-09-13', 'V0013', 30.00, '60000'), 
  ('E002', 'MTNGLD002', 'C013', '2016-09-13', 'V0013', 80.00, '60000'), 
  ('E003', 'MTNGLD003', 'C013', '2016-09-13', 'V0013', 15.00, '60000'), 
  ('E004', 'MTNGLD004', 'C013', '2016-09-13', 'V0013', 30.00, '60000'), 

  ('E000', 'MTNGLD000', 'C013', '2017-06-13', 'V0013', 60.00, '80000'), -- GOLD
  ('E001', 'MTNGLD001', 'C013', '2017-06-13', 'V0013', 30.00, '80000'), 
  ('E002', 'MTNGLD002', 'C013', '2017-06-13', 'V0013', 80.00, '80000'), 
  ('E003', 'MTNGLD003', 'C013', '2017-06-13', 'V0013', 15.00, '80000'), 
