...
insert into MaintenanceVisitOrder
  ...
  ('E002', 'MTN000', 'C000', '2015-04-13', 'V0000', 22.50, '50000'), -- PKG000 
  ('E003', 'MTN001', 'C000', '2015-04-13', 'V0000', 22.50, '50000'),
  ('E004', 'MTN000', 'C000', '2015-04-30', 'V0000', 22.50, '65000'), -- PKG000
  ('E001', 'MTN001', 'C000', '2016-04-30', 'V0000', 22.50, '65000'), 
  ('E006', 'MTNSIL000', 'C001', '2015-04-11', 'V0001', 47.00, '50000'), -- SILVER 
  ('E005', 'MTNSIL001', 'C001', '2015-04-11', 'V0001', 32.00, '50000'), 
  ('E006', 'MTNSIL000', 'C001', '2016-04-13', 'V0001', 47.00, '65000'), -- SILVER 
  ('E003', 'MTNSIL001', 'C001', '2016-04-13', 'V0001', 32.00, '65000'), 
  ('E000', 'MTNSIL000', 'C001', '2017-04-13', 'V0001', 47.00, '80000'), -- SILVER 
  ('E007', 'MTNSIL001', 'C001', '2017-04-13', 'V0001', 32.00, '80000'), 

  ('E001', 'MTN002', 'C002', '2016-04-12', 'V0002', 52.00, '135000'), -- PKG001
  ('E000', 'MTN003', 'C002', '2016-04-12', 'V0002', 52.00, '135000'), 

  ('E001', 'MTN019', 'C003', '2017-04-14', 'V0003', 32.00, '55000'), -- PKG009
  ('E005', 'MTN020', 'C003', '2017-04-14', 'V0003', 32.00, '70000'), 

  ('E004', 'MTN011', 'C004', '2016-12-13', 'V0004', 132.00, '55000'), -- PKG005
  ('E003', 'MTN012', 'C004', '2016-12-13', 'V0004', 132.00, '55000'), 
  ('E000', 'MTN011', 'C004', '2017-04-23', 'V0004', 132.00, '70000'), -- PKG005
  ('E002', 'MTN012', 'C004', '2017-04-23', 'V0004', 132.00, '70000'), 

  ('E001', 'MTNBRZ000', 'C005', '2015-04-13', 'V0005', 37.00, '35000'), -- BRONZE
  ('E006', 'MTNBRZ001', 'C005', '2015-04-13', 'V0005', 42.00, '35000'), 

  ('E001', 'MTNBSC000', 'C006', '2016-03-13', 'V0006', 32.00, '10000'), -- BASIC
  ('E003', 'MTNBSC001', 'C006', '2017-05-13', 'V0006', 42.00, '15000'), 

  ('E002', 'MTN015', 'C007', '2015-06-13', 'V0007', 32.00, '90000'), -- PKG007
  ('E004', 'MTN016', 'C007', '2015-06-13', 'V0007', 22.00, '90000'), 

  ('E001', 'MTN005a', 'C008', '2017-04-13', 'V0008', 62.00, '70000'), -- PKG002
  ('E001', 'MTN005b', 'C008', '2017-04-13', 'V0008', 17.00, '70000'), 

  ('E007', 'MTN017', 'C009', '2015-07-13', 'V0009', 32.00, '130000'), -- PKG008
  ('E005', 'MTN018', 'C009', '2015-07-13', 'V0009', 32.00, '130000'), 

  ('E001', 'MTN006', 'C010', '2015-07-13', 'V0010', 57.00, '35000'), -- PKG003
  ('E002', 'MTN007', 'C010', '2015-07-13', 'V0010', 22.00, '35000'), 

  ('E006', 'MTN006', 'C010', '2016-08-13', 'V0010', 57.00, '45000'), -- PKG003
  ('E002', 'MTN007', 'C010', '2016-08-13', 'V0010', 22.00, '45000'), 

  ('E002', 'MTN008', 'C011', '2017-01-13', 'V0011', 27.00, '95000'), -- PKG004
  ('E004', 'MTN009', 'C011', '2017-01-13', 'V0011', 32.00, '95000'), 
  ('E006', 'MTN010', 'C011', '2017-01-13', 'V0011', 32.00, '95000'), 

  ('E001', 'MTN011', 'C012', '2016-04-13', 'V0012', 132.00, '95000'), -- PKG005
  ('E000', 'MTN012', 'C012', '2016-04-13', 'V0012', 132.00, '95000'), 

  ('E000', 'MTNGLD000', 'C013', '2016-9-13', 'V0013', 62.00, '60000'), -- GOLD
  ('E001', 'MTNGLD001', 'C013', '2016-9-13', 'V0013', 32.00, '60000'), 
  ('E002', 'MTNGLD002', 'C013', '2016-9-13', 'V0013', 82.00, '60000'), 
  ('E003', 'MTNGLD003', 'C013', '2016-9-13', 'V0013', 17.00, '60000'), 
  ('E004', 'MTNGLD004', 'C013', '2016-9-13', 'V0013', 32.00, '60000'), 

  ('E000', 'MTNGLD000', 'C013', '2017-6-13', 'V0013', 62.00, '80000'), -- GOLD
  ('E001', 'MTNGLD001', 'C013', '2017-6-13', 'V0013', 32.00, '80000'), 
  ('E002', 'MTNGLD002', 'C013', '2017-6-13', 'V0013', 82.00, '80000'), 
  ('E003', 'MTNGLD003', 'C013', '2017-6-13', 'V0013', 17.00, '80000'), 
  ('E004', 'MTNGLD004', 'C013', '2017-6-13', 'V0013', 32.00, '80000'), 

  ('E001', 'MTN024', 'C014', '2015-4-21', 'V0014', 17.00, '25000'), -- null
