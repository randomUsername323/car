...
insert into Vehicle
  ...
  ('V0001', 'Ford', 'Focus', '2009', '40,000', 'C001', 'SILVER'),
...
insert into ServiceAppointment
  ...
  ('2017-4-13', 'C001', 'V0001', 'E002', '04:30 PM', '75000', '2.25'),
...
insert into MaintenanceVisitOrder
  ...
  ('E001', 'MTN002', 'C002', '2016-04-13', 'V0002', 52.00, '95000'), -- PKG001
  ('E000', 'MTN003', 'C002', '2016-04-13', 'V0002', 52.00, '95000'), 

  ('E001', 'MTN019', 'C003', '2017-04-13', 'V0003', 32.00, '95000'), -- PKG009
  ('E005', 'MTN020', 'C003', '2017-04-13', 'V0003', 32.00, '95000'), 

  ('E004', 'MTN011', 'C004', '2016-12-13', 'V0004', 132.00, '85000'), -- PKG005
  ('E003', 'MTN012', 'C004', '2016-12-13', 'V0004', 132.00, '85000'), 
  ('E000', 'MTN011', 'C004', '2017-04-13', 'V0004', 132.00, '85000'), -- PKG005
  ('E002', 'MTN012', 'C004', '2017-04-13', 'V0004', 132.00, '85000'), 

  ('E001', 'MTNBRZ000', 'C005', '2015-04-13', 'V0005', 37.00, '95000'), -- BRONZE
  ('E006', 'MTNBRZ001', 'C005', '2015-04-13', 'V0005', 42.00, '95000'), -- BRONZE

  ('E001', 'MTNBSC000', 'C006', '2016-04-13', 'V0006', 32.00, '85000'), -- BASIC
  ('E003', 'MTNBSC001', 'C006', '2016-04-13', 'V0006', 42.00, '85000'), 

  ('E002', 'MTN015', 'C007', '2015-04-13', 'V0007', 32.00, '95000'), -- PKG007
  ('E004', 'MTN016', 'C007', '2015-04-13', 'V0007', 22.00, '95000'), 

  ('E001', 'MTN005a', 'C008', '2017-04-13', 'V0008', 62.00, '70000'), -- PKG002
  ('E001', 'MTN005b', 'C008', '2017-04-13', 'V0008', 17.00, '70000'), 

  ('E017', 'MTN001', 'C009', '2015-04-13', 'V0009', 32.00, '95000'), -- PKG008
  ('E018', 'MTN001', 'C009', '2015-04-13', 'V0009', 32.00, '95000'), 

  ('E001', 'MTN001', 'C010', '2015-04-13', 'V0010', 30.00, '85000'), -- PKG003

  ('E001', 'MTN001', 'C010', '2016-08-13', 'V0010', 30.00, '85000'), -- PKG003

  ('E001', 'MTN001', 'C010', '2016-08-13', 'V0010', 30.00, '85000'), -- PKG003

  ('E001', 'MTN001', 'C011', '2017-04-13', 'V0011', 30.00, '95000'), -- PKG004

  ('E001', 'MTN001', 'C012', '2016-04-13', 'V0012', 30.00, '95000'), -- PKG005

  ('E001', 'MTN001', 'C013', '2016-4-13', 'V0013', 30.00, '50000'), -- GOLD

  ('E001', 'MTN001', 'C013', '2017-4-13', 'V0013', 30.00, '55000'), -- GOLD

  ('E001', 'MTN001', 'C014', '2015-4-13', 'V0014', 30.00, '95000'), -- null
